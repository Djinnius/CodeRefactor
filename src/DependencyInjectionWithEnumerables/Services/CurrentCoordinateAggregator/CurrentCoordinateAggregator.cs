...
public class CurrentCoordinateAggregator : ICurrentCoordinateAggregator
{
    ...
    private readonly ICurrentCoordinateProvider _coordinateProvider;

    /// <inheritdoc cref="CurrentCoordinateAggregator"/>
    public CurrentCoordinateAggregator(ICurrentCoordinateProvider coordinateProvider)
    {
    ...
    public Coordinate GetCurrentCoordinate()
    {
        ...
        var coordinate1 = _coordinateProvider.GetSensorCoordinate1();
        var coordinate2 = _coordinateProvider.GetSensorCoordinate2();
        var coordinate3 = _coordinateProvider.GetSensorCoordinate3();
