...
public class CoordinateAggregator
{
    ...
    public CoordinateAggregator(CoordinateProvider coordinateProvider)
    {
        _coordinateProvider = coordinateProvider; // or new CoordinateProvider(new CachingService());
    }
